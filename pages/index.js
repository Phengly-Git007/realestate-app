...
export default function Home({propertyForSale,propertyForRent}) {
  ...
  return (
    <Box>
      <Banner 
        purpose="RENT A HOME" title1="Rental homes for" title2="Everyone" 
        desc1="explore apartment,villars,condos,home" desc2="and more" 
        buttonText="Explore Renting" linkName="/search?purpose=for-rent"
        imageUrl="https://bayut-production.s3.eu-central-1.amazonaws.com/image/145426814/33973352624c48628e41f2ec460faba4"
        />

      <Flex flexWrap={'wrap'} >
        {/* fetch property and map(loop) them from api */}
      {propertyForRent.map((property)=> <Property property={property} key={property.id}/>)}
      </Flex>

      <Banner 
      
        purpose="BUY A HOME" title1="find , buy and own your  " title2="Dream" 
        desc1="explore apartment,villars,condos,home" desc2="and more" 
        buttonText="Explore Buying" linkName="/search?purpose=for-sale"
